...
private void showEmpData()
{
    try
    {
        ArrayList<EmpPojo> receptionist=ReceptionistDao.getAllReceptionist();
        Object []rows=new Object[4];
        DefaultTableModel model=(DefaultTableModel)jtEmpData.getModel();
        for(EmpPojo e:receptionist)
        {
            rows[0]=e.getEmpid();
            rows[1]=e.getEmpname();
            rows[2]=e.getJob();
    ...
    private void initComponents() {
        ...
        jtEmpData.setBackground(new java.awt.Color(255, 255, 255));
        jtEmpData.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
