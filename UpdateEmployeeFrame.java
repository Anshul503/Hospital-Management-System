...
private HashMap<String,EmpPojo> empDetails;
    ...
    private void initComponents() {
        ...
        jcJob.addItemListener(new java.awt.event.ItemListener() {
            public void itemStateChanged(java.awt.event.ItemEvent evt) {
                jcJobItemStateChanged(evt);
            }
        });
        ...
        btnUpdate.setFont(new java.awt.Font("Copperplate Gothic Bold", 1, 18)); // NOI18N
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
          if(!validateInput())
        {
            ...
            try
          {
            ...
            boolean status=EmpDao.updateEmployee(emp);
            if(status)
            {
    ...
    private void jcJobItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_jcJobItemStateChanged
            
    }//GEN-LAST:event_jcJobItemStateChanged
